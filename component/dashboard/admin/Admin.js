...
const PageContent = ({ path }) => {
  switch (path) {
      ...
      return (
        <Box>
          <Typography paragraph>
            Xem và quản lý các đơn đặt phòng của bạn tại đây.
          </Typography>
    ...
    case "/reports":
      return (
        <Box>
          ...
          <Typography paragraph>Xem báo cáo và phân tích của bạn.</Typography>
        </Box>
      );
    case "/sales":
      return (
    ...
    case "/category":
      return (
        <Box>
          <Typography paragraph>Quản lý danh mục của bạn.</Typography>
          <Category />
        </Box>
      );
      ...
      >
        <Toolbar sx={{ minHeight: 72 }}>
          ...
          <Typography
            ...
            sx={{ fontWeight: 600 }}
          >
            {router.pathname === "/dashboard" && "Tổng quan"}
            {router.pathname === "/orders" && "Danh sách đặt phòng"}
            {router.pathname === "/profile" && "Hồ sơ cá nhân"}
            {router.pathname === "/team" && "Thành viên đội ngũ"}
            {router.pathname === "/teamlist" && "Danh sách đội ngũ"}
            ...
            {router.pathname === "/traffic" && "Báo cáo khách sạn"}
            {router.pathname === "/category" && "Danh mục"}
            {router.pathname === "/blog" && "Blog"}
            {router.pathname === "/bloglist" && "Danh sách blog"}
            {![
              "/dashboard",
              "/orders",
              "/profile",
