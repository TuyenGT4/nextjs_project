  ...
  if (active && payload && payload.length) {
    return (
      ...
      >
        ...
        >
          {payload[0].value.toLocaleString()} Người dùng
        </p>
      </motion.div>
    );
  }
...
export default function ModernTriangleChart() {
  ...
  if (loading) {
    return (
      ...
      >
        <p style={{ color: "white" }}> Đang tải dữ liệu người dùng...</p>
      </div>
    );
  }
    ...
    >
      ...
      >
        <div>
          ...
          >
            Lưu lượng người dùng theo tháng
          </h2>
          <p
            style={{
              color: "#64748b",
          ...
          >
            Lượng người đăng ký theo tháng
          </p>
        </div>
      </div>
