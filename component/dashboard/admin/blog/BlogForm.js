...
const BlogForm = () => {
  ...
  const generateAIContent = async (type) => {
    if (!formData.category) {
      setLocalError("Vui lòng chọn danh mục trước khi tạo nội dung");
      return;
    }
    ...
    try {
      ...
      setLocalError(
        `Không thể tạo ${type} , ${error.message || "Vui lòng thử lại sau"}`
      );
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(error.message || "Không thể tạo bài viết");
    }
  };
        ...
        <Box sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
          ...
          <Box sx={{ flex: 1, position: "relative" }}>
            <TextField
              ...
              sx={textFieldStyles}
            />
            <Tooltip title="Tạo tiêu đề bằng AI">
              <IconButton
        ...
        <Box sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
          ...
          <Box sx={{ flex: 1, position: "relative" }}>
            <TextField
              ...
              sx={textFieldStyles}
            />
            <Tooltip title="Tạo mô tả bằng AI">
              <IconButton
