...
export default function ProfileUpdateForm() {
  ...
  const validateForm = () => {
    ...
    if (!name) errors.name = "Yêu cầu nhập tên";

    if (!email) errors.email = "Yêu cầu nhập email";

    if (mobileNumber && !/^[0-9]{10}$/.test(mobileNumber)) {
      errors.mobileNumber = " Hãy nhập số điện thoại hợp lệ";
    }
    ...
    if (
      ...
      errors.country = "Hãy chọn một quốc gia";
    }

    if (!password) errors.password = "Yêu cầu nhập mật khẩu";
