...
export async function POST(req) {
  ...
  try {
    ...
    const newBooking = new Booking({
      ...
      total_price: parseFloat(total.toLocaleString("vi-VN")),
    ...
    const options = {
      amount: parseFloat(total.toLocaleString("vi-VN") * 100), // Convert the course price to the smallest unit (paise) for Razorpay
